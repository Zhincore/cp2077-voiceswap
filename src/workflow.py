...
async def workflow(args:Namespace):
  ...
  pbar = tqdm(desc="Overall progress", total=8, bar_format="{l_bar}|{bar}| {n_fmt}/{total_fmt}{postfix}")
  ...
  print()
  print("Congratulations! The workflow is done!")
  print(f"Your mod can be found in the current directory as '{args.name}.zip'")
