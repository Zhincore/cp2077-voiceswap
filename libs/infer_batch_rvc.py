...
def arg_parse() -> tuple:
    ...
    parser.add_argument("--f0_path", type=str, default=None, help="path to f0 files")
...
def main():
    ...
    for file in tq.tqdm(audios):
        if file.endswith(".wav"):
            ...
            f0_path = None
            if args.f0_path:
                f0_path = os.path.join(args.f0_path, file.replace(".wav", ".f0"))
                if not os.path.exists(f0_path):
                    tq.write(f"F0 file for {file} was not found")
                    f0_path = None
            ...
            _, wav_opt = vc.vc_single(
                ...
                file_path,
                args.f0up_key,
                Namespace(name=f0_path) if f0_path else None,
                args.f0method,
                args.index_path,
                None,
                args.index_rate,
